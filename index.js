...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Both nestedFunction() and the variable internal are in the same block code. Therefore as long as internal was declared, the next function can access it. 
  ...
  */
  ...
  function animalNames(){
    ...
    zooAnimals.forEach(function(array) {
      zooArray.push(`name: ${array.animal_name}, scientific: ${array.scientific_name}`);
    });
    return zooArray;
  }
